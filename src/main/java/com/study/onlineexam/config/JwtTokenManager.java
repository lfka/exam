...
import com.study.onlineexam.utils.EncodesUtil;
...
public class JwtTokenManager {
    ...
    public String issuedToken(String iss, long ttlMillis, String sessionId, Map<String,Object> claims){
        ...
        //获取加密签名
        String base64EncodedSecretKey = EncodesUtil.encodeBase64("base64EncodedSecretKey".getBytes());
        //构建令牌
    ...
    public boolean isVerifyToken(String jwtToken){
        //带着签名构建校验对象
        Algorithm algorithm = Algorithm.HMAC256("base64EncodedSecretKey".getBytes());
